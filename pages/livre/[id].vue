<template>
  <main data-namespace="single-book" class="w-full grid grid-cols-1 md:grid-cols-2 gap-8" >
    ...
    <div class="">
      <h1 v-if="livre" class="text-4xl font-bold tracking-tight uppercase mb-4">{{ livre.titre }}</h1>

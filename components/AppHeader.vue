<template>
    <header class="sticky top-4">
        <!--<nav>
            ...
            <nav class="rounded-lg border shadow-lg overflow-hidden p-2 bg-white border-stone-200 shadow-stone-950/5  mx-auto w-full">
                <div class="flex items-center">
                <NuxtLink to="/" class="font-sans antialiased text-sm text-current ml-2 mr-2 block py-1 font-semibold">Bibliothèque</NuxtLink>
